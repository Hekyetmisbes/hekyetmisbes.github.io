...
/* FONT PREVIEW NOTE:
  ...
  and a clean sans-serif for body text. Tailwind defaults are used here for compatibility.
*/
...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      links: [{ label: "GitHub", url: "https://github.com/Hekyetmisbes/flag-quiz-game" }]
    },
    {
      title: "Platform",
      genre: "2D Platformer",
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500 selection:text-black overflow-x-hidden">
      ...
      {/* --- HUD NAVIGATION --- */}
      <nav className={`fixed top-0 w-full z-40 transition-all duration-300 border-b ${scrolled ? 'bg-slate-900/90 backdrop-blur-md border-cyan-500/30 py-3' : 'bg-transparent border-transparent py-6'}`}>
      ...
      {/* --- FOOTER / GAME OVER --- */}
      <section id="contact" className="py-20 bg-black text-center relative border-t border-slate-800">
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-12">
            <a href="mailto:harunemrecankarabag@gmail.com" className="flex items-center gap-3 px-6 py-4 bg-slate-900 rounded-lg hover:bg-slate-800 transition-colors border border-slate-800 hover:border-cyan-500 group">
