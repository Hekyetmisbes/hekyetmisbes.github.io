...
const Portfolio = () => {
  ...
  const [showLatestUpdate, setShowLatestUpdate] = useState(true);
  ...
  const experiences = [
    ...
    },
    {
      ...
      impact: "Reduced new route integration time with a modular mission flow and now offers a playable public demo on itch.io.",
      links: [
        { label: "Play on itch.io", url: "https://hekyetmisbes.itch.io/delivery-driver", event: "project_demo_click", kind: "primary" },
        { label: "View Source", url: "https://github.com/Hekyetmisbes/Delivery-Driver", event: "github_click" }
      ]
    },
    {
      title: "Movidle Game",
      ...
      links: [
        { label: "View Source", url: "https://github.com/Hekyetmisbes/Movidle-Game", event: "github_click" },
    ...
    },
    {
      ...
      links: [
        { label: "View Source", url: "https://github.com/Hekyetmisbes/platform", event: "github_click" }
      ]
    }
  ];
  const skills = {
      ...
      <nav aria-label="Main navigation" className={`fixed top-0 w-full z-40 transition-all duration-300 border-b ${scrolled ? 'bg-slate-900/90 backdrop-blur-md border-cyan-500/30 py-3' : 'bg-transparent border-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 text-sm font-mono uppercase tracking-widest">
            {['Start', 'Stats', 'Quests', 'Levels', 'Side Quest'].map((item) => (
              <button 
                key={item}
            ...
            <div className="relative flex items-center gap-4">
              ...
              <button
                aria-label="Toggle updates list"
              ...
              {showUpdatesPanel && (
                <div className="absolute right-0 top-8 w-80 bg-slate-900/95 backdrop-blur border border-cyan-500/30 rounded-lg p-4 shadow-2xl z-50">
                  <p className="text-cyan-400 font-bold text-xs uppercase tracking-wider mb-3">Updates</p>
                      ...
                      <div key={index} className="border border-slate-800 rounded-md p-3 bg-slate-950/80">
                        ...
                        {update.ctaUrl && update.ctaLabel && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            onClick={() => trackEvent("project_demo_click", { project: "Delivery Driver", source: "updates_panel", label: update.ctaLabel })}
                    ...
                    <div className="flex flex-wrap justify-end gap-2">
                      {project.links.map((link, i) => (
                        <a
                          ...
                          onClick={() => trackEvent(link.event, { project: project.title, label: link.label })}
          ...
          <div className="max-w-sm rounded-xl border border-cyan-500/30 bg-slate-900/90 p-4 shadow-2xl backdrop-blur">
            ...
            {latestUpdate.ctaUrl && latestUpdate.ctaLabel && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                onClick={() => trackEvent("project_demo_click", { project: "Delivery Driver", source: "floating_update", label: latestUpdate.ctaLabel })}
